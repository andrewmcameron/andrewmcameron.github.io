...
R is where it's at.
Since being introduced to R and RStudio, they have become essential components of many (if not most) of my computer-based workflows.
...
Among other projects, I developed a script to facilitate the longitudinal monitoring and analysis of <a href="https://blogs.vcu.edu/pabukaveckas/research/james-river-ecosystem-study/">chlorophyll a (CHLa) levels in the James River</a>.
...
::: row
<div style="text-align: center; margin-top: 20px; margin-bottom: 15px;">
  <img src="media/gunmap.png" alt="model predictive success" height="410" 
...
-  <b><a href="osmdata_tutorial.html" target="blank">`osmdata` tutorial</a></b> 
