...
<br>
<div class="text">
The projects below were all carried out using some combination of ArcGIS Pro and R.
The R language and RStudio interface have become essential parts of my GIS workflows - particularly when it comes to data exploration, wrangling, and manipulation.
</div>
...
I used these attributes to derive a model of probable species distribution within United States that radically reduces the area of likely occurrence as compared with the official USGS species range polygon. The project primarily involved raster analysis: deriving slope and aspect from digital elevation models, extracting raster cells based on specified attributes and mask polygons, reclassifying cells to standardized values, and overlaying raster layers to aggregate the values of their cells.
</div>
